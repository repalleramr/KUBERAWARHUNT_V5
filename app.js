...
function vijayDarshanaDisplay(info){ const bet=currentBetFor(info); const displayStep=Math.max(1, Number(info.step)||0); const displayNet=(bet*8)-(Number(info.prevLoss)||0); return { bet, displayStep, displayNet }; }
